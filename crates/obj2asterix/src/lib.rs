...
use spec_parser::spec_xml::{Category, Variable, Explicit, Compound, Repetitive, Format, Fixed};
...
mod tests {
    ...
    fn foobar() {
        ...
        println!("written in: {:0.1}", elapsed.as_secs_f64() / iters as f64 * 1e9);
        println!("per second: {:0.1}K", iters as f64 / elapsed.as_secs_f64() / 1e3);
